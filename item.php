				...
				<header class="header2">
					...
					<nav class="navigation2">
    					<ul class="navigation__list2">
							...
							<li class="navigation__list-item2"><a href="regist.php" class="navigation__link2">ジュエリー</a></li>
    						<li class="navigation__list-item2"><a href="information.php" class="navigation__link2">フレグランス</a></li>
    						<li class="navigation__list-item2"><a href="contact.php" class="navigation__link2">ウォッチ</a></li>
							<li class="navigation__list-item2"><a href="logout.php" class="navigation__link2">ギフト</a></li>
   						 </ul>
  					</nav>
				</header>
			</td>
